/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4faa605213359f7240363857d68d2042)
// Runtime types generated with workerd@1.20260515.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	CLOUDFLARE_ACCOUNT_ID: string;
	CLOUDFLARE_AI_API_TOKEN: string;
	CLOUDFLARE_AI_WORKER_NAME: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_AI_API_TOKEN" | "CLOUDFLARE_AI_WORKER_NAME">> {}
}
