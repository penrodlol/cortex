/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f89cb169a50707535dfde3a424fab1a1)
...
interface __BaseEnv_Env {
	...
	CLOUDFLARE_DAILY_RETRY_LIMIT: string;
	CLOUDFLARE_DAILY_SLEEP_LIMIT: string;
	CLOUDFLARE_DAILY_SCHEDULED_PUBLISHED_DAYS_LIMIT: string;
	CLOUDFLARE_DAILY_QUEUE_REPING_LIMIT: string;
	CLOUDFLARE_WEB_BOT_AUTH_JWK: string;
	SUPADATA_API_KEY: string;
	YOUTUBE_API_KEY: string;
	GITHUB_API_KEY: string;
	GITHUB_TRENDING_URL: string;
	GITHUB_TRENDING_ELEMENT_SELECTOR: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_ACCESS_TOKEN" | "CLOUDFLARE_AI_MODEL" | "CLOUDFLARE_D1_ID" | "CLOUDFLARE_DAILY_RETRY_LIMIT" | "CLOUDFLARE_DAILY_SLEEP_LIMIT" | "CLOUDFLARE_DAILY_SCHEDULED_PUBLISHED_DAYS_LIMIT" | "CLOUDFLARE_DAILY_QUEUE_REPING_LIMIT" | "CLOUDFLARE_WEB_BOT_AUTH_JWK" | "SUPADATA_API_KEY" | "YOUTUBE_API_KEY" | "GITHUB_API_KEY" | "GITHUB_TRENDING_URL" | "GITHUB_TRENDING_ELEMENT_SELECTOR" | "X_ACCESS_TOKEN" | "X_ACCESS_TOKEN_SECRET" | "X_API_KEY" | "X_API_SECRET_KEY">> {}
}
