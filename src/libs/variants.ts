  ...
  const variants = tv({
    variants: {
      ...
      variant: {
        ...
        'gray-ghost': { [slot]: ['text-gray-11 ring-accent-8', hover && 'hover:text-gray-12 hover:bg-gray-3'] },
        ...
        'gray-accent-ghost': { [slot]: ['text-accent-11 ring-accent-8', hover && 'hover:text-accent-12 hover:bg-accent-3'] },
        ...
        'gray-warn-ghost': { [slot]: ['text-warn-11 ring-warn-8', hover && 'hover:text-warn-12 hover:bg-warn-3'] },
        ...
        'gray-danger-ghost': { [slot]: ['text-danger-11 ring-danger-8', hover && 'hover:text-danger-12 hover:bg-danger-3'] },
        ...
        'accent-ghost': { [slot]: ['text-accent-11 ring-accent-8', hover && 'hover:text-accent-12 hover:bg-accent-3'] },
        ...
        'warn-ghost': { [slot]: ['text-warn-11 ring-warn-8', hover && 'hover:text-warn-12 hover:bg-warn-3'] },
        ...
        'danger-ghost': { [slot]: ['text-danger-11 ring-danger-8', hover && 'hover:text-danger-12 hover:bg-danger-3'] },
